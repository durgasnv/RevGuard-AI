...
def estimate_probability(
    ...
    if txn.failure_category in (FailureCategory.RISK_RELATED,
                                ...
                                FailureCategory.ACCOUNT_RESTRICTION):
        return 0.0
    if action == RecoveryAction.RETRY_PAYMENT and (
    ...
    if burst_detected and action == RecoveryAction.RETRY_PAYMENT \
            and txn.failure_category == FailureCategory.TRANSIENT:
