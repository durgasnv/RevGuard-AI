    ...
    <div className="space-y-5">
      ...
      {ptpInvoice && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-xs">
          <div className="w-full max-w-md rounded-2xl border border-border bg-card text-card-foreground p-6 shadow-xl space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-input bg-background p-2 text-foreground focus:outline-ring focus:ring-1"
                />
              </div>
            ...
            <div className="flex items-center justify-end gap-2 pt-2">
              <button
                onClick={() => setPtpInvoice(null)}
                className="rounded-lg bg-secondary text-secondary-foreground hover:bg-secondary/80 px-3.5 py-1.5 text-xs font-semibold transition-colors"
              >
                Cancel
              </button>
              <button
                onClick={submitPtp}
                className="rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 px-4 py-1.5 text-xs font-semibold shadow-xs transition-colors"
              >
                Save PTP Commitment
              </button>
            </div>
