...
export default function LandingView({
  ...
  return (
    <div className="min-h-screen bg-[#07090e] text-slate-100 font-sans selection:bg-blue-600 selection:text-white overflow-x-hidden">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <span className="text-base font-bold tracking-tight text-white">RevGuard</span>
                <span className="rounded bg-blue-500/20 px-1.5 py-0.5 text-[10px] font-bold text-blue-300 border border-blue-400/30">
                  AI
                </span>
              </div>
              <div className="text-[10px] text-slate-400 font-mono">Revenue Recovery Control Tower</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="hidden sm:inline-flex items-center gap-1.5 rounded-full border border-amber-500/30 bg-amber-500/10 px-3 py-1.5 text-xs font-semibold text-amber-300 hover:bg-amber-500/20 transition-all"
            >
              <span>🏆</span>
            ...
            <button
              onClick={onEnterDashboard}
              className="inline-flex items-center gap-2 rounded-full bg-blue-600 hover:bg-blue-500 active:bg-blue-700 px-4 py-2 text-xs font-semibold text-white shadow-lg shadow-blue-600/30 transition-all hover:scale-[1.02]"
            >
      ...
      <section className="relative pt-20 pb-16 px-6 text-center max-w-5xl mx-auto space-y-8">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 px-5 py-3.5 text-sm font-semibold text-slate-200 transition-all hover:border-white/20"
          >
        ...
        <div className="pt-4 flex flex-wrap items-center justify-center gap-6 text-xs text-slate-500 font-mono">
          <span className="flex items-center gap-1.5">
            <span className="text-emerald-400 font-bold">✓</span> +18.4% Measured Counterfactual Uplift
          </span>
          <span>·</span>
          <span className="flex items-center gap-1.5">
            <span className="text-blue-400 font-bold">🛡️</span> Rule SC-01 Zero-Fatigue Guard
          </span>
          <span>·</span>
          <span className="flex items-center gap-1.5">
            <span className="text-purple-400 font-bold">🎙️</span> 2-Way Voice (STT + TTS)
          </span>
        </div>
      </section>
      ...
      <section id="demo-preview" className="px-4 sm:px-6 py-8 max-w-6xl mx-auto">
        <div className="relative rounded-3xl border border-white/[0.08] bg-[#0c1017]/90 p-4 sm:p-6 shadow-2xl backdrop-blur-2xl space-y-6">
          {/* Mockup Topbar */}
          <div className="flex flex-wrap items-center justify-between gap-4 border-b border-white/[0.06] pb-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-bold text-white tracking-tight">RevGuard Control Tower</span>
            </div>

            {/* Fake Search Pill */}
            <div className="hidden md:flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-xs text-slate-400 w-72">
              <span>🔍</span>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-2.5 py-1 text-xs text-slate-300">
                <img
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="rounded-2xl border border-white/[0.08] bg-gradient-to-br from-[#121824] via-[#0d121c] to-[#07090e] p-6 space-y-3 relative overflow-hidden">
              <div className="flex justify-between items-center text-xs text-slate-400">
                <span className="font-semibold uppercase tracking-wider text-[11px] text-slate-400">
                  Total Revenue Recovered
                </span>
                <span className="pill-button bg-white/5 border border-white/10 text-slate-300 text-[10px]">
                  Batch 600 txns
                </span>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-slate-400">(+₹1.82L vs Blind Retry)</span>
              </div>
            </div>

            {/* Right Mini Stream Cards */}
            <div className="lg:col-span-2 grid grid-cols-2 sm:grid-cols-4 gap-3">
              <div className="obsidian-card-sm p-3.5 space-y-1.5">
                <div className="text-[10px] text-slate-400 uppercase font-semibold">UPI 2.0 Failover</div>
                <div className="text-sm font-bold text-white">₹3,84,000</div>
                <div className="text-[10px] text-emerald-400 font-semibold">68 re-routed</div>
              </div>
              <div className="obsidian-card-sm p-3.5 space-y-1.5">
                <div className="text-[10px] text-slate-400 uppercase font-semibold">Voice Bot (PTP)</div>
                <div className="text-sm font-bold text-white">₹2,45,000</div>
                <div className="text-[10px] text-blue-400 font-semibold">82% Intent Confirmed</div>
              </div>
              <div className="obsidian-card-sm p-3.5 space-y-1.5">
                <div className="text-[10px] text-slate-400 uppercase font-semibold">Mandate Ladder</div>
                <div className="text-sm font-bold text-white">₹8,12,000</div>
                <div className="text-[10px] text-purple-400 font-semibold">Stage 2 Liquidity</div>
              </div>
              <div className="obsidian-card-sm p-3.5 space-y-1.5">
                <div className="text-[10px] text-slate-400 uppercase font-semibold">SC-01 Blocked</div>
                <div className="text-sm font-bold text-rose-400">42 Stopped</div>
                <div className="text-[10px] text-slate-400 font-semibold">0 Fatigue Violations</div>
              </div>
            </div>
          </div>

          {/* Performance Area Chart Preview */}
          <div className="rounded-2xl border border-white/[0.08] bg-[#0d121c] p-5 space-y-3">
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div>
                <h3 className="text-sm font-bold text-white">Recovery Trajectory vs. Naïve Baseline</h3>
                <p className="text-[11px] text-slate-400">Measured money recovered across time under deterministic policy bounds</p>
              </div>
              <div className="flex items-center gap-1 rounded-full border border-white/10 bg-white/5 p-1 text-[10px] font-semibold">
                <span className="px-2 py-0.5 text-slate-400">1D</span>
                <span className="px-2 py-0.5 text-slate-400">1W</span>
                <span className="px-2 py-0.5 rounded-full bg-blue-600 text-white shadow">1M</span>
                <span className="px-2 py-0.5 text-slate-400">6M</span>
                <span className="px-2 py-0.5 text-slate-400">ALL</span>
              </div>
            </div>
            ...
            <div className="h-40 w-full pt-3">
              <svg className="w-full h-full overflow-visible" viewBox="0 0 800 150">
                ...
                <circle cx="600" cy="25" r="5" fill="#38bdf8" className="animate-ping" />
                <circle cx="600" cy="25" r="4" fill="#ffffff" stroke="#2563eb" strokeWidth="2" />
              </svg>
            </div>

            <div className="flex justify-between items-center text-[10px] font-mono text-slate-500 pt-1 border-t border-white/[0.04]">
              <span className="flex items-center gap-1.5 text-blue-400 font-semibold">
                <span className="h-2 w-2 rounded-full bg-blue-400" /> RevGuard-AI Strategy (₹19.62L)
              </span>
              <span className="flex items-center gap-1.5 text-slate-400">
                <span className="h-2 w-2 rounded-full bg-slate-500" /> Naïve Retry Baseline (₹17.80L)
              </span>
              <span className="text-emerald-400 font-bold">Net Uplift: +₹1,82,450 (+18.4%)</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="calculator" className="px-6 py-16 max-w-5xl mx-auto space-y-10">
        <div className="text-center space-y-3">
          <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-3.5 py-1 text-xs font-semibold text-emerald-400 font-mono">
        ...
        <div className="rounded-3xl border border-white/[0.08] bg-[#0c1017] p-6 sm:p-8 shadow-2xl grid grid-cols-1 lg:grid-cols-12 gap-8">
          {/* Sliders (Left Column) */}
          <div className="lg:col-span-7 space-y-6">
            {/* Slider 1: Monthly Volume */}
            <div className="space-y-2">
              <div className="flex justify-between text-xs">
                <span className="font-semibold text-slate-300">Monthly Processing Volume</span>
                <span className="font-mono font-bold text-blue-400 text-sm">{inr(monthlyVolume)}</span>
              </div>
              <input
                type="range"
                min={1000000}
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-xs">
                <span className="font-semibold text-slate-300">Average Payment Failure Rate</span>
                <span className="font-mono font-bold text-rose-400 text-sm">{failureRate}%</span>
              </div>
              <input
                type="range"
                min={4}
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-xs">
                ...
                <span className="font-mono font-bold text-purple-400 text-sm">{inr(aov)}</span>
              </div>
              <input
                type="range"
                min={500}
          ...
          <div className="lg:col-span-5 rounded-2xl border border-emerald-500/20 bg-emerald-950/20 p-6 flex flex-col justify-between space-y-4 shadow-inner">
            <div>
            ...
            <div className="space-y-2.5 border-t border-emerald-500/20 pt-4 text-xs font-mono">
              <div className="flex justify-between text-slate-300">
                ...
                <span className="text-rose-400 font-bold">{inr(grossAtRisk)}</span>
              </div>
              <div className="flex justify-between text-slate-300">
                <span>Monthly Won Back:</span>
                <span className="text-emerald-400 font-bold">{inr(estimatedRecovered)}</span>
              </div>
              <div className="flex justify-between text-slate-300">
                <span>Wasted Gateway Fees Saved:</span>
                <span className="text-blue-400 font-bold">-81.6%</span>
              </div>
            </div>
      ...
      <section id="features" className="px-6 py-16 max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="obsidian-card p-6 space-y-4 hover:border-blue-500/30 transition-all">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-blue-500/10 text-xl text-blue-400">
              🎙️
            </div>
            <h3 className="text-base font-bold text-white">2-Way Bilingual Voice AI</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
              Integrated real-time Speech-to-Text (`webkitSpeechRecognition`) supporting <b>English</b> & <b>Hinglish</b>. Voice commitments automatically register active Promise-to-Pay (PTP) records.
            </p>
          </div>

          {/* Bento 2: Bank Switch Health Radar */}
          <div className="obsidian-card p-6 space-y-4 hover:border-emerald-500/30 transition-all">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-500/10 text-xl text-emerald-400">
              🚦
            </div>
            <h3 className="text-base font-bold text-white">Acquiring Switch Failover (SC-02)</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="obsidian-card p-6 space-y-4 hover:border-purple-500/30 transition-all">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-purple-500/10 text-xl text-purple-400">
              🚀
            </div>
            <h3 className="text-base font-bold text-white">Autonomous Batch Simulator</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="obsidian-card p-6 space-y-4 hover:border-amber-500/30 transition-all">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-amber-500/10 text-xl text-amber-400">
              💬
            </div>
            <h3 className="text-base font-bold text-white">Slack / Teams CFO Bridge</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="obsidian-card p-6 space-y-4 hover:border-indigo-500/30 transition-all">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-indigo-500/10 text-xl text-indigo-400">
              📋
            </div>
            <h3 className="text-base font-bold text-white">B2B Receivables & PTP Ledger</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
              4-tier aging buckets (*1–30d*, *31–60d*, *61–90d*, *90+d*) with automated escalating dunning and customer Promise-to-Pay state machine verification.
            </p>
          </div>

          {/* Bento 6: Margin-Bounded Dynamic Yield */}
          <div className="obsidian-card p-6 space-y-4 hover:border-cyan-500/30 transition-all">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-cyan-500/10 text-xl text-cyan-400">
              ⚡
            </div>
            <h3 className="text-base font-bold text-white">Dynamic Incentive EV Optimizer</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
              Calculates dynamic checkout incentives (instant cashback / discounts) bounded strictly by merchant gross margin constraints to maximize Expected Value ($EV$).
            </p>
          </div>
        </div>
      </section>
      ...
      {/* ── 6. Footer CTA ─────────────────────────────────────────── */}
      <footer className="border-t border-white/[0.06] bg-[#0c1017] py-12 px-6">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
          <div className="space-y-1">
            <div className="flex items-center justify-center sm:justify-start gap-2">
              <span className="text-base font-bold text-white">RevGuard·AI</span>
              <span className="rounded bg-blue-500/20 px-1.5 py-0.5 text-[9px] font-bold text-blue-300">
                Enterprise
              </span>
            </div>
            <p className="text-xs text-slate-500">
              Autonomous Revenue Recovery Control Tower · Built for the Hackathon
            </p>
          </div>
